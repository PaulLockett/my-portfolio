...
public final class FindMeetingQueryTest {
  ...
  public void everyOptionalAttendeeIsConsidered() {
    // Have each person have different events. We should see three options 
  ...
  @Test
  public void noTimesForOptionalAttendees() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  : |------A------||------B-------|
  ...
  @Test
  public void OpptionalAttendeeOverBooked() {
    // Have each person have different events. We should see two options 
    // because each required person has split the restricted times and the
    // optional person has no avalible times.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C*-------------|
    // Day     : |-----------------------------|
  ...
  public void OpptionalAttendeeCanAttend() {
    // Have each person have different events. We should see two options 
    // because each required person has split the restricted times and the
    // optional person has no avalible times.
    //
